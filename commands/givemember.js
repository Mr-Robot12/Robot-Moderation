...
exports.run = function(client, message, args) {
  ...
  guild.member(message.mentions.members.first()).addRole('347322157606502422').catch(error => console.log(error));
  embed.setTitle("__Member Role Given__")
  .setDescription(`The Member Role has been given to ${member}.`)
